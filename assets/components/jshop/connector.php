...
$corePath = $modx->getOption('js.core_path',null,$modx->getOption('core_path').'components/jshop/');
require_once $corePath.'model/jshop/jshop.class.php';
$modx->js = new jShop($modx);
 
$modx->lexicon->load('jshop:default');
 
/* handle request */
$path = $modx->getOption('processorsPath',$modx->js->config,$corePath.'processors/');
