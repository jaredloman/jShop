...
*/
class jShopOrderDetailsManagerController extends jShopManagerController {
    public function process(array $scriptProperties = array()) {
 
    }
    public function getPageTitle() { return $this->modx->lexicon('js.orders'); }
    public function loadCustomCssJs() {
        //$this->addJavascript($this->js->config['jsUrl'].'mgr/widgets/orders/order.update.window.js');
