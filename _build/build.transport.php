...
$sources= array (
    ...
    'hooks' => $root.'core/components/'.PKG_NAME_LOWER.'/hooks/',
...
$vehicle->resolve('php',array(
    'source' => $sources['resolvers'] . 'statuses.resolver.php',
));
$vehicle->resolve('php',array(
    'source' => $sources['resolvers'] . 'categories.resolver.php',
));
