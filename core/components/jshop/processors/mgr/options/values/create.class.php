...
*/
class OptionValsCreateProcessor extends modObjectCreateProcessor {
    public $classKey = 'jsOptionVals';
    public $languageTopics = array('jshop:default');
    public $objectType = 'js.optionvals';
 	public function beforeSet() {
		$optId = $this->getProperty('optId',0);
		if($optId == 0) {
			$this->addFieldError('name','Something went wrong...Call Jared!');
		}
		$this->setProperty('optId',$optId);
...
return 'OptionValsCreateProcessor';