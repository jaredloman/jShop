jShop.panel.Item = function(config) {
    config = config || {};
    Ext.apply(config,{
    ...
    jShop.panel.Item.superclass.constructor.call(this,config);
};
Ext.extend(jShop.panel.Item,MODx.FormPanel);
Ext.reg('jshop-panel-item',jShop.panel.Item);